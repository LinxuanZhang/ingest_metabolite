...
manifest = pl.read_csv('unfin.csv')

file_names = manifest['accessionId'].to_list()
failed_urls = []

def process_file(file_name):
    download_url = f'https://ftp.ebi.ac.uk/pub/databases/gwas/summary_statistics/GCST90301001-GCST90302000/{file_name}/{file_name}.tsv'
